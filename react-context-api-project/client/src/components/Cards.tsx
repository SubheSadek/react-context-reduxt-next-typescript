...
export default class Card extends Component{
    ...
    render(){
        let cards = (<CardContext.Consumer>
            {({users, deleteUser} :any) => users.map((user :any, i :number)=>{
                return (
                            ...
                            <div className="_react_card_content_inner">
                                <div className="_react_card_content_inner_icon_wrap">
                                    <div className="_react_card_content_inner_icon">
                                        <svg onClick={() => {if (window.confirm('Are you sure you wish to delete this user?')) deleteUser(user.id , i)}} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash card_delete_icon" viewBox="0 0 16 16">
